...
export function useArchiveSearch(params: { q?: string; tags?: string[] }) {
  const { q, tags } = params;
  return useInfiniteQuery<ArchiveListResponse, Error, ArchiveListResponse, any[], string | undefined>({
...
export function useArchiveEntry(slug: string | undefined) {
  return useQuery<ArchiveEntryDetail | null>({
    ...
    queryFn: async () => {
      if (!slug) return null;
      const res = await fetch(`/api/archive/entry?slug=${encodeURIComponent(slug)}`);
...
export function useCreateArchiveEntry() {
  ...
  return useMutation({
    mutationFn: async (input: { entity: string; body?: string; tags?: string[] }) => {
      const res = await fetch("/api/archive/create", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(input) });
...
export function useUpdateArchiveEntry() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (input: { slug: string; entity?: string; body?: string; addTags?: string[]; removeTags?: string[] }) => {
      const res = await fetch("/api/archive/update", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(input) });
...
export function useDeleteArchiveEntry() {
  ...
  return useMutation({
    mutationFn: async (input: { slug: string }) => {
      const res = await fetch("/api/archive/delete", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(input) });
...
export function useLinkArchiveEntries() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (input: { sourceSlug: string; targetSlug: string; type: string; bidirectional?: boolean }) => {
      const res = await fetch("/api/archive/link", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(input) });
...
export function useUnlinkArchiveEntries() {
  const qc = useQueryClient();
  return useMutation({
    mutationFn: async (input: { sourceSlug: string; targetSlug: string; type: string }) => {
      const res = await fetch("/api/archive/unlink", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(input) });
...
export function useArchiveSlugSuggestions(query: string | undefined) {
  return useQuery<{ slug: string; entity: string; tags: string[] }[]>({
    ...
    queryFn: async () => {
      ...
      return (data.entries || []).map((e: any) => ({ slug: e.slug, entity: e.entity, tags: e.tags }));
    },
    staleTime: 15_000,
  });
}
...
export type PinnedArchiveEntry = { slug: string; entity: string; tags: string[]; updatedAt: string; pinnedAt: string; bodyPreview?: string };
...
export function usePinnedArchiveEntries(chatId: string | undefined) {
  return useQuery<PinnedArchiveEntry[]>({
    ...
    queryFn: async () => {
      if (!chatId) return [];
      const res = await fetch(`/api/archive/pinned?chatId=${encodeURIComponent(chatId)}`);
...
export function usePinArchiveEntry() {
  ...
  return useMutation({
    mutationFn: async (input: { chatId: string; slug: string }) => {
      const res = await fetch("/api/archive/pin", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(input) });
...
export function useUnpinArchiveEntry() {
  ...
  return useMutation({
    mutationFn: async (input: { chatId: string; slug: string }) => {
      const res = await fetch("/api/archive/unpin-from-chat", { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(input) });
