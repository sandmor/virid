  ...
  tool({
    ...
    inputSchema: z.object({
      entity: z
        .string()
        .min(1)
        .describe('Short title for what this entry is about'),
      slug: z
        .string()
        .optional()
        .describe('Desired unique slug (optional). Will be adjusted if taken.'),
      body: z
        .string()
        .optional()
        .describe('Full body text for the memory entry'),
      ...
      links: z
        ...
        .optional()
        .describe('Links to other existing entries'),
    }),
